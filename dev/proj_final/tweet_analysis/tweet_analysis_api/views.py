    ...
    def rate_video(self,request,pk = None):
        if 'stars' in request.data:
            ...
            try:
                ...
                response = {'message':'rating had been updated', 'result':serializer.data}
            ...
            responde = {'message':'Please enter stars for the rating'}
            return Response(response,status=status.HTTP_400_BAD)
...
class RatingViewSet(viewsets.ModelViewSet):
    ...
    def delete(self,request,*args,**kwargs):
        responde = {'message': 'Rating cannot be updated like this'}
